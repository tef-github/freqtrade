...
class Romeo_ai_optimizer_a1:
    ...
    def modify_running_backtest_parameters(self,D_UP,D_UP_MAX):
        ...
        print("Romeo_ai_optimizer_a1: change_parameters_in_config: successfully written DUP and MAX_COUNT_DUP to brain_config.py")
    ...
    def initiate_backtest(self,coin="BTC",month=1,year=2020,logfile=""):
        print("Romeo_ai_optimizer_a1: Coin=",coin)
        print("Romeo_ai_optimizer_a1: month=",month)
        print("Romeo_ai_optimizer_a1: year=",year)
        print("Romeo_ai_optimizer_a1: logfile=",logfile)
        ...
        for strategy in self.strategy_configuration:
            ...
            for dup in self.float_range(self.DUP_FLOOR,self.DUP_CEILING,self.DUP_STEP_FORWARD):
                for dup_max_counter in self.float_range(self.MAX_COUNT_DUP_FLOOR,self.MAX_COUNT_DUP_CEILING,self.MAX_COUNT_DUP_STEP_FORWARD):
                    ...
                    print("==============================================Romeo_ai_optimizer_a1: completed backtest===============================")
    ...
    def read_cumulative_profit_from_file(self):
        ...
        with open(self.cumulative_profit_path,'rt') as cumulative_profit:
            ...
            return float(cumulative_profit)


if __name__=="__main__":
    romeo_ai_optimizer_runner = Romeo_ai_optimizer_a1()
